...
static uint32_t _FromStringToParticleFlag( const char *str )
{
	// if ( ! str )
	// {
	// 	return 0;
...
static uint32_t _FromStringToParticleGroupFlag( const char *str )
{
	// if ( ! str )
	// {
	// 	return 0;
...
namespace // anonymous namespace.
{
	...
	public:
		...
		float ReportParticle( const b2ParticleSystem* particleSystem,
